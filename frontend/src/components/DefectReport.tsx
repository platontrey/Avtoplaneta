...
export default function DefectReport() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-8">
      <Link to="/add-car" className="flex items-center gap-1 text-muted-foreground hover:text-foreground mb-6 text-sm sm:text-base">
        <ArrowLeft size={16} />
        Назад к выбору действия
      </Link>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Создание дефектной ведомости</h2>
      <p className="text-muted-foreground mb-8 text-base sm:text-lg">Будет создана дефектная ведомость со всеми распространёнными запчастями для автомобиля.</p>

      <div className="bg-card text-card-foreground rounded-lg border border-border p-4 sm:p-8 shadow-lg w-full max-w-4xl">
